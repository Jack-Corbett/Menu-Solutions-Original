        ...
        if ($_SESSION['admin'] == 1) {
            ...
            <div class="w3-container">
                ...
                <p>Welcome to the admin page. You can only access this if you have been granted permission.
                    From here you can help me improve the Menu Solutions experience by adding new recipes which will be
                    used to generate users weekly meal plans.
                ...
                <p>1. Give your recipe a name and tell me how long it takes to cook in minutes.<br/>
                    2. Write out numbered instructions making a new line for each new step (the same format as these
                    instructions). Do not press submit until all the recipes have been entered.<br/>
                    3. Fill in the ingredient name (always use the plural with brackets eg: Potato(es) or Carrot(s)),
                    how it is measured, the quantity needed (this is per person and if there is no set
                    portion eg: serve with carrots enter 0) and pick a category. The other category is for ingredients
                    that do not fit in to the other categories and the hide category is used for
                    ingredients the user doesn&#39;t need on their shopping list such as water.<br/>
                    4. To add the rest of the ingredients just click the Add an Ingredient button and another set of
                    boxes will appear. Repeat this for all ingredients
            ...
            <div class="w3-card-4">
                ...
                <form action="../_includes/admin/addrecipe.inc.php" method="POST" class="w3-padding w3-center">
                    ...
                    <br/><br/>
                    <!--Instructions-->
                    <textarea ROWS=3 COLS=30 name="instructions" placeholder="Instructions" style="width:100%"
