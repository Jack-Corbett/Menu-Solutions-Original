...
<div class="page-wrap">
    ...
    <div class="w3-container w3-center">
        ...
        <div class="w3-card-4">
            ...
            <p>Here you can register for your Menu Solutions account, simply fill in the form below and press sign
                up</p>
            ...
            <div class="w3-text-red">
                ...
                } elseif (strpos($url, 'error=characterfirst')) {
                    echo "Only letters and spaces allowed in first name";
                } elseif (strpos($url, 'error=characterlast')) {
                    echo "Only letters and spaces allowed in surname";
                } elseif (strpos($url, 'error=invalidemail')) {
                    echo "Invalid email address";
                } elseif (strpos($url, 'error=emailinuse')) {
