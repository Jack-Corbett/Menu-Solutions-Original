...
<!-- Parallax Image with logo and title -->
<div class="bgimg-1 w3-opacity w3-display-container" style="white-space:nowrap;">
    <img src="_img/logo.png" height="auto" width="60" class="w3-display-middle-above w3-animate-opacity">
    ...
    ?> class="w3-display-middle-below w3-center w3-btn w3-animate-opacity w3-hover-light-grey w3-theme-d1">START EATING
        SMARTER</a>
    <div class="w3-display-bottommiddle-above">
        <a onclick="document.getElementById('tutorial').style.display='block'"
           class="w3-centre w3-btn w3-animate-opacity w3-dark-grey w3-round-large w3-small">TUTORIAL</a>
    </div>
</div>
      ...
      <span onclick="document.getElementById('tutorial').style.display='none'"
        ...
        <div id="Add Family" class="w3-container w3-text-grey display">
            <p>First you need to add your family members and fill in
                ...
                To add a member simply select add members from the drop down in the top bar or press the round green
                plus button.
                This will take you to a page where you can fill in their first name, surname and gender. Once that is
                filled in press the green add person
                button.</p>
            <div class="w3-center">
        ...
        <div id="Members" class="w3-container w3-text-grey display">
            <p>You can manage your family from the members page. To delete a family member just press the x on the far
                right and the tick to confirm.
                To edit their information just press the pencil and when your finished press the green tick to save your
                changes. </p>
            <div class="w3-center">
        ...
        <div id="Plan" class="w3-container w3-text-grey display">
            <p>The plan page is where you input who will be eating each day
                and tell us how long you will have to cook. Click on the tab for each day and use the checkboxes to
                select
                ...
                plan button or if you press generate meal plan again you will be asked if you would like to delete your
                current plan.
        ...
        <div id="Calendar" class="w3-container w3-text-grey display">
            <p>The calendar page is where you can see your meal plan for the current week. It is also how
                ...
                are eating each day, respresented by the number of heads. To see the instructions for a recipe just
                click
                the recipe name and it will take you to a page with everything you need to get cooking. It even works
                out the
        ...
        <div id="List" class="w3-container w3-text-grey display">
            <p>The list page contains the shopping list for your latest meal plan. You can see the ingredients split
                into categories
                to make them easy to find in the supermarket. It also shows you exactly how much of each you need to
                feed the amount of people
