...
<div class="page-wrap">
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if ($plan_id === NULL) {
            ?>
            <p class="w3-text-red w3-center">To view your meal plan you must first visit the plan page and generate
                one.</p>
            ...
            <ul class="w3-ul w3-card-4 w3-animate-opacity">
                ...
                for ($i = 0; $i < 7; $i++) {
                    ...
                    <li class="w3-padding-16">
                        ...
                        <a href="<?php echo 'dayrecipe.php?' . $recipe_id[$i]; ?>" class="w3-medium"
                           style="text-decoration: none"><?php echo $recipe_name; ?></a>
