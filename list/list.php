        ...
        if ($plan_id === NULL) {
            ...
            <table class="w3-table-all w3-card-4 w3-hide-small w3-hide-medium">
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        OutputArray($fv_amount, $fv_measure, $fv_name, 0);
                        ?>
                    </td>
                    ...
                    <td>
                        <?php
                        OutputArray($pr_amount, $pr_measure, $pr_name, 0);
                        ?>
                    </td>
                    ...
                    <td>
                        <?php
                        OutputArray($ca_amount, $ca_measure, $ca_name, 0);
                        ?>
                    </td>
                    ...
                    <td>
                        <?php
                        OutputArray($da_amount, $da_measure, $da_name, 0);
                        ?>
                    </td>
                    ...
                    <td>
                        <?php
                        OutputArray($un_amount, $un_measure, $un_name, 0);
                        ?>
                    </td>
                </tr>
            </table>
