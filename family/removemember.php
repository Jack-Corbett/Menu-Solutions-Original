...
<div class="page-wrap">
  ...
  <div class="w3-container w3-center">
    ...
    <div class="w3-card-4">
      ...
      <a href="../_includes/family/remove-delete.inc.php?member=<?php echo $member_id; ?>" class="w3-btn w3-hover-dark-grey w3-theme-d1 w3-round-xlarge"><i class="fa fa-check" aria-hidden="true"></i></a>
