...
<div class="page-wrap">
  ...
  <br /><br />
    ...
    <?php
  	...
  	<li class="w3-padding-16">
	    <a href="removemember.php?member=<?php echo $member_id; ?>" class="w3-closebtn w3-margin-right w3-large w3-hover-text-red">×</a>
	    <a href="editmember.php?member=<?php echo $member_id; ?>" class="w3-margin-right w3-right"> <i class="fa fa-pencil w3-hover-text-blue" aria-hidden="true"></i></a>
	    <img src=
      <?php
        if ($gender == 'm') {
  ...
  <div class="w3-container w3-padding">
    <a class="w3-btn-floating w3-theme-d1 w3-hover-dark-grey" style="text-decoration: none" href="addmember.php" >+</a>
  </div>
