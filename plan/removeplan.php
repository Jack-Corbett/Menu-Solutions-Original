...
<div class="page-wrap">
  ...
  <div class="w3-container w3-center">
    ...
    <div class="w3-card-4 w3-center">
      ...
      <a href="../_includes/plan/remove-plan.inc.php" class="w3-btn w3-hover-dark-grey w3-theme-d1 w3-round-xlarge"><i class="fa fa-check" aria-hidden="true"></i></a>
      <a href="plan.php" class="w3-btn w3-hover-dark-grey w3-red w3-round-xlarge"><i class="fa fa-times" aria-hidden="true"></i></a>
      <br /><br />
    </div>
  </div>
