...
<div class="w3-container w3-row-padding w3-dark-grey">
  ...
  <p class="w3-center">In order to start using this Menu Solutions please create an account by clicking on
    the login button at the top right of the screen. Once your account has been set up, by clicking register from the login page,
  ...
  <p class="w3-center">The calendar tab is where you can see your meal plan for the current week. It is also how
    you will access your recipes each day when cooking. To see the instructions for that day just click the recipe name
    and it will take you to a page with everything you need to get cooking. It even works out the quantities based on
    how many are eating for you. Finally there is the list tab which generates a shopping list for your current meal plan,
...
<div class="w3-container w3-row-padding w3-dark-grey">
  <div class="w3-twothird">
    <h3>Jack Corbett</h3>
    <p>I am currently studying my A Levels at Barton Peveril College and this is my second year Computer Science Project.
    When given the task to code pretty much anything I wanted to I really wanted to solve a problem and create a product
    that I was proud of and believed actually warranted the time and effort put into it. I know that trying to decide what
    to eat each day is a struggle for many families and that is why often bad habbits are started. It is so important to
    eat healthy food as it affects everything you do and so I wanted to make it easy for everyone by providing a simple
    solution to a complex problem.</p>
    <p>Another issue I wanted to solve was to decrease food wastage which along with diet is the other biggest issue that we
    face. That is why I have built in an inventory system so that you only buy what you need and reuse ingredients rather than
    just getting rid of the excess. This site is still in very early development and many of the final features are not yet
    present but I would really appreciates anyones support and suggestions on how I could improve it as I am working alone on
...
<div class="w3-container w3-row-padding w3-dark-grey w3-topbar">
  ...
  <ul>
    <li type="square">W3 Schools for allowing open use of their CSS template which is excellent for beginers to webdesign and
    their wide range of tutorials</li>
    <li type="square">PHP and MySQL for Dynamic Websites by Larry Ulman is a brilliant book that takes you step by step
    through building your website and keeping it secure</li>
